    ...
    if is_linux:
        ...
        config = {
            ...
            'BIPED': {
                ...
                'data_dir': 'C:/Users/default.DESKTOP-D5VGE5V/Desktop/TEED-main/datasets/BIPED',  # mean_rgb
                'yita': 0.5,
                'mean':BIPED_mean
            #
            },
        ...
        config = {
            ...
            'BIPED': {'img_height': 720,  # 720
                      ...
                      # 'train_list': 'train_rgb.lst',
                      'data_dir': 'C:/Users/default.DESKTOP-D5VGE5V/Desktop/TEED-main/datasets/BIPED',  # WIN: '../.../dataset/BIPED/edges'
                      'yita': 0.5,
                      'mean':BIPED_mean},
            'BIPED-B2': {'img_height': 720,  # 720
                      'img_width': 1280,  # 1280
